...
Currently the only supported model is this one https://huggingface.co/SpeechTek/Italian-EE-conformer and its english equivalent https://huggingface.co/SpeechTek/English-EE-conformer.
...
## N.B.
I have an error with streamlit-webrtc, specifically on_audio_ended parameter of webrtc_streamer. So before running, Modify the shutdown.py file in ```.venv/lib/python3.11/site-packages/streamlit_webrtc/``` line 126.
